...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        afaqInfo.setText("I'm Afaque Alam though i like to go by the name 'Alpha'. Developing this app has truly been an amazing experience for me. I also build video games.\nPress the icon below to follow me on GitHub");
